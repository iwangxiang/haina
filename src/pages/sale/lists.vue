                            ...
                            <virtual-list :size="50" :remain="8">
                                ...
                                <div class="isShowlistCont">
                                    <div class="isShowBtn">
                                        ...
                                        <div class="isShowBtnContent">
                                            <button v-for="item in mjs" :key="item.id" :class="{btnClass:mj==item.notes}"
                                                    @click="getMj(item.notes)">{{item.name}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="isShowlistCont">
                                    <div class="isShowBtn">
                                        <h2>朝向</h2>
                                        <div class="isShowBtnContent">
                                            <button v-for="item in towards" :key="item.id" :class="{btnClass:cx==item.id}"
                                                    @click="getCx(item.id)">{{item.name}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="isShowlistCont">
                                    <div class="isShowBtn">
                                        <h2>标签</h2>
                                        <div class="isShowBtnContent">
                                            <button v-for="item in tags" :key="item.id" :class="{btnClass:yt==item.id}"
                                                    @click="getYt(item.id)">{{item.name}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="isShowlistCont">
                                    <div class="isShowBtn">
                                        <h2>装修</h2>
                                        <div class="isShowBtnContent">
                                            <button v-for="item in zxzks" :key="item.id" :class="{btnClass:zxzk==item.id}"
                                                    @click="getZxzk(item.id)">{{item.name}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="isShowlistCont">
                                    <div class="isShowBtn">
                                        <h2>电梯</h2>
                                        <div class="isShowBtnContent">
                                            <button v-for="(item,index) in elevators" :key="index"
                                                    :class="{btnClass:elevator==index}" @click="getElevator(index)">{{item}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="isShowlistCont">
                                    <div class="isShowBtn">
                                        <h2>用途</h2>
                                        <div class="isShowBtnContent">
                                            <button v-for="item in wylxs" :key="item.id" :class="{btnClass:wylx==item.id}"
                                                    @click="getWylx(item.id)">{{item.name}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    import {saleList} from "../../config/api";
                    ...
                    saleList(params).then(res => {
                        if(res.code == 0){//请求成功
                            if(this.page == 0){                            
                                ...
                                this.wylxs = Object.values(res.data.wylxs);
                                this.zxzks = Object.values(res.data.zxzks);
